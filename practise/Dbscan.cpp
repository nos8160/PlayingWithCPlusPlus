...
float arrTotal[4][300];//Index 0=sepalLength,1=sepalWidth,2=petalLength,3=petalWidth
float arrTemp[4][300];//Index 0=sepalLength,1=sepalWidth,2=petalLength,3=petalWidth
int totalIdx=0;
